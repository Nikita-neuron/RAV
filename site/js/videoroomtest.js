...
var server = "http://192.168.0.28:8088/janus"
						...
						janus.attach(
							{
								...
								success: function(pluginHandle) {
									...
									registerUsername();
									$('#videoremote').click(function() {
										janus.destroy();
										noVideo.style.display = "block";
										document.getElementById('videoremote').classList.remove("play-video");
									});
								},
	...
	janus.attach(
		{
			...
			onremotestream: function(stream) {
				...
				if($('#remotevideo').length === 0) {
					...
					$('#videoremote').append('<video class="rounded centered relative hide" id="remotevideo' + '" width="100%" height="100%" autoplay playsinline/>');
					$('#videoremote').append(
